...
double *MainWindow::preencheCamposXYZAtual(double *posicoesAtuaisGraus)
{
    ...
    ui->edtRxAtual->setText(QString("%L1%2").arg(posGarra[3], 0, 'f', CASAS_DECIMAIS_ROTACOES_XYZ - 1).arg(STR_UND_GRAUS));
    ui->edtRyAtual->setText(QString("%L1%2").arg(posGarra[4], 0, 'f', CASAS_DECIMAIS_ROTACOES_XYZ - 1).arg(STR_UND_GRAUS));
    ui->edtRzAtual->setText(QString("%L1%2").arg(posGarra[5], 0, 'f', CASAS_DECIMAIS_ROTACOES_XYZ - 1).arg(STR_UND_GRAUS));
